...
- `CODEX_SEMANTIC_OUTPUT_TIMEOUT_MS` — Maximum idle time (ms) while waiting for ChatGPT Codex text, tool output, or reasoning-summary progress. Active reasoning renews the window. Default: `180000`
